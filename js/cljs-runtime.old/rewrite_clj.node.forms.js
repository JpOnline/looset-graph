...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k20222,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k20222,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__20249){
var vec__20252 = p__20249;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20252,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20252,(1),null);
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__20221){
var self__ = this;
var G__20221__$1 = this;
return (new cljs.core.RecordIter((0),G__20221__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this20223,other20224){
var self__ = this;
var this20223__$1 = this;
return (((!((other20224 == null)))) && ((((this20223__$1.constructor === other20224.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this20223__$1.children,other20224.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this20223__$1.__extmap,other20224.__extmap)))))));
}));
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k20222){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k20222);

}
}));

(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__20221){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__20344 = cljs.core.keyword_identical_QMARK_;
var expr__20345 = k__5352__auto__;
if(cljs.core.truth_((pred__20344.cljs$core$IFn$_invoke$arity$2 ? pred__20344.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__20345) : pred__20344.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__20345)))){
return (new rewrite_clj.node.forms.FormsNode(G__20221,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.forms.FormsNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__20221),null));
}
}));
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__20221){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.forms.FormsNode(self__.children,G__20221,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.forms.map__GT_FormsNode = (function rewrite_clj$node$forms$map__GT_FormsNode(G__20230){
var extmap__5385__auto__ = (function (){var G__20371 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__20230,new cljs.core.Keyword(null,"children","children",-940561982));
...
return (new rewrite_clj.node.forms.FormsNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__20230),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
