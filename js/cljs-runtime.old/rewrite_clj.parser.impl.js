...
if((c === "\n")){
var G__21509 = escape_QMARK_;
var G__21510 = rewrite_clj.parser.impl.flush_into(lines,buf);
escape_QMARK_ = G__21509;
lines = G__21510;
continue;
} else {
buf.append(c);

var G__21511 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__21512 = lines;
escape_QMARK_ = G__21511;
lines = G__21512;
continue;
