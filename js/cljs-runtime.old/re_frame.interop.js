...
return [(function (){var pred__15989 = cljs.core.instance_QMARK_;
var expr__15990 = reactive_val;
if(cljs.core.truth_((pred__15989.cljs$core$IFn$_invoke$arity$2 ? pred__15989.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__15990) : pred__15989.call(null,reagent.ratom.RAtom,expr__15990)))){
return "ra";
} else {
if(cljs.core.truth_((pred__15989.cljs$core$IFn$_invoke$arity$2 ? pred__15989.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__15990) : pred__15989.call(null,reagent.ratom.RCursor,expr__15990)))){
return "rc";
} else {
if(cljs.core.truth_((pred__15989.cljs$core$IFn$_invoke$arity$2 ? pred__15989.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__15990) : pred__15989.call(null,reagent.ratom.Reaction,expr__15990)))){
return "rx";
} else {
if(cljs.core.truth_((pred__15989.cljs$core$IFn$_invoke$arity$2 ? pred__15989.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__15990) : pred__15989.call(null,reagent.ratom.Track,expr__15990)))){
return "tr";
} else {
return "other";
}
