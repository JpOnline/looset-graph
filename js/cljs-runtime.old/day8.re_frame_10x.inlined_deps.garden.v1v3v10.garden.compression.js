 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.compression.token_fn = (function day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$compression$token_fn(p__12932){
var vec__12933 = p__12932;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12933,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12933,(1),null);
return (function (s){
...
var len__5769__auto___12985 = arguments.length;
var i__5770__auto___12986 = (0);
while(true){
if((i__5770__auto___12986 < len__5769__auto___12985)){
args__5775__auto__.push((arguments[i__5770__auto___12986]));

var G__12987 = (i__5770__auto___12986 + (1));
i__5770__auto___12986 = G__12987;
continue;
} else {
}
break;
...
return (function (s){
return cljs.core.some((function (p1__12936_SHARP_){
return (p1__12936_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__12936_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__12936_SHARP_.call(null,s));
}),fs);
});
}));
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq12937){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq12937));
}));
...
var map__12971 = temp__5802__auto__;
var map__12971__$1 = cljs.core.__destructure_map(map__12971);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12971__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12971__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12971__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__12993 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__12994 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__12978 = tag;
