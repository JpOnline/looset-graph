...
var G__17061 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__17061;
continue;
} else {
return ch;
...
var vec__17025 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17025,(0),null);
return (match === s);
});
...
var len__5769__auto___17068 = arguments.length;
var i__5770__auto___17069 = (0);
while(true){
if((i__5770__auto___17069 < len__5769__auto___17068)){
args__5775__auto__.push((arguments[i__5770__auto___17069]));

var G__17070 = (i__5770__auto___17069 + (1));
i__5770__auto___17069 = G__17070;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq17039){
...
return (function() { 
var G__17071__delegate = function (rdr,_){
...
var G__17071 = function (rdr,var_args){
var _ = null;
...
while (G__17072__i < G__17072__a.length) {G__17072__a[G__17072__i] = arguments[G__17072__i + 1]; ++G__17072__i;}
  _ = new cljs.core.IndexedSeq(G__17072__a,0,null);
} 
return G__17071__delegate.call(this,rdr,_);};
G__17071.cljs$lang$maxFixedArity = 1;
G__17071.cljs$lang$applyTo = (function (arglist__17073){
var rdr = cljs.core.first(arglist__17073);
var _ = cljs.core.rest(arglist__17073);
return G__17071__delegate(rdr,_);
});
