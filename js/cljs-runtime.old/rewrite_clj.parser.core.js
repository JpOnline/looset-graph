...
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__21918 = cljs.core.get_global_hierarchy;
return (fexpr__21918.cljs$core$IFn$_invoke$arity$0 ? fexpr__21918.cljs$core$IFn$_invoke$arity$0() : fexpr__21918.call(null));
})());
...
return rewrite_clj.reader.read_repeatedly(reader,(function (p1__21926_SHARP_){
var _STAR_delimiter_STAR__orig_val__21927 = rewrite_clj.parser.core._STAR_delimiter_STAR_;
var _STAR_delimiter_STAR__temp_val__21928 = delimiter;
(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__temp_val__21928);

try{return rewrite_clj.parser.core.parse_next(p1__21926_SHARP_);
}finally {(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__orig_val__21927);
}}));
});
...
(rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__21939){
var vec__21941 = p__21939;
var ignore_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21941,(0),null);
...
/** @this {Function} */
(rewrite_clj.parser.core.parse_printables.cljs$lang$applyTo = (function (seq21932){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21933,G__21934,G__21935,seq21932__$3);
}));
...
var G__21955 = rewrite_clj.reader.peek(reader);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__21955)){
return rewrite_clj.reader.throw_reader(reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("!",G__21955)){
...
return cljs.core.cons((function (){var G__21956 = rewrite_clj.reader.peek(reader);
switch (G__21956) {
case "(":
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("_",G__21955)){
