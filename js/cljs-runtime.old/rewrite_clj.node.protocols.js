...
var rewrite_clj$node$protocols$Node$tag$dyn_20220 = (function (node){
...
return rewrite_clj$node$protocols$Node$tag$dyn_20220(node);
}
});

var rewrite_clj$node$protocols$Node$node_type$dyn_20231 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$node_type$dyn_20231(node);
}
});

var rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_20232 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_20232(node);
}
});

var rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_20237 = (function (node,opts){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_20237(node,opts);
}
});

var rewrite_clj$node$protocols$Node$length$dyn_20244 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$length$dyn_20244(node);
}
});

var rewrite_clj$node$protocols$Node$string$dyn_20248 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$string$dyn_20248(node);
}
});
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__19978_SHARP_){
return rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(p1__19978_SHARP_,opts);
...
var rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_20279 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_20279(node);
}
});

var rewrite_clj$node$protocols$InnerNode$children$dyn_20285 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$children$dyn_20285(node);
}
});

var rewrite_clj$node$protocols$InnerNode$replace_children$dyn_20291 = (function (node,children){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$replace_children$dyn_20291(node,children);
}
});

var rewrite_clj$node$protocols$InnerNode$leader_length$dyn_20299 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$leader_length$dyn_20299(node);
}
});
...
var rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_20310 = (function (form){
...
return rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_20310(form);
}
});
...
var rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_20319 = (function (node,map_qualifier){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_20319(node,map_qualifier);
}
});

var rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_20324 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_20324(node);
}
});
...
var map__20172 = cljs.core.meta(node);
var map__20172__$1 = cljs.core.__destructure_map(map__20172);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20172__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20172__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var next_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20172__$1,new cljs.core.Keyword(null,"next-row","next-row",-408963777));
var next_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20172__$1,new cljs.core.Keyword(null,"next-col","next-col",601697889));
...
rewrite_clj.node.protocols._PLUS_extent = (function rewrite_clj$node$protocols$_PLUS_extent(p__20189,p__20190){
var vec__20192 = p__20189;
var row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20192,(0),null);
var col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20192,(1),null);
var vec__20195 = p__20190;
var row_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20195,(0),null);
var col_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20195,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(row + row_extent),(function (){var G__20200 = col_extent;
if((row_extent === (0))){
return (G__20200 + col);
} else {
return G__20200;
...
if(cljs.core.truth_(rewrite_clj.node.protocols.inner_QMARK_(node))){
var G__20206 = rewrite_clj.node.protocols.children(node);
var G__20206__$1 = (((G__20206 == null))?null:cljs.core.first(G__20206));
if((G__20206__$1 == null)){
return null;
} else {
return cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.tag,rewrite_clj.node.protocols.sexpr)(G__20206__$1);
}
} else {
