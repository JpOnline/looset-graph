 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.units.convert = (function day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$convert(p__14603,right){
var map__14604 = p__14603;
var map__14604__$1 = cljs.core.__destructure_map(map__14604);
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14604__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14604__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__14607 = temp__5804__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14607,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14607,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14607,(2),null);
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14616__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__14617 = u(y);
var map__14617__$1 = cljs.core.__destructure_map(map__14617);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14617__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3 = (function() { 
var G__14719__delegate = function (x,y,more){
...
var G__14719 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__14722__i = 0, G__14722__a = new Array(arguments.length -  2);
while (G__14722__i < G__14722__a.length) {G__14722__a[G__14722__i] = arguments[G__14722__i + 2]; ++G__14722__i;}
  more = new cljs.core.IndexedSeq(G__14722__a,0,null);
} 
return G__14719__delegate.call(this,x,y,more);};
...
return G__14719__delegate(x,y,more);
});
...
G__14725 = new cljs.core.IndexedSeq(G__14726__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__14725);
}
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14620__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__14621 = u(y);
var map__14621__$1 = cljs.core.__destructure_map(map__14621);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14621__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
...
var G__14732 = null;
if (arguments.length > 2) {
var G__14733__i = 0, G__14733__a = new Array(arguments.length -  2);
while (G__14733__i < G__14733__a.length) {G__14733__a[G__14733__i] = arguments[G__14733__i + 2]; ++G__14733__i;}
G__14732 = new cljs.core.IndexedSeq(G__14733__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__14732);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14633__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__14635 = u(y);
var map__14635__$1 = cljs.core.__destructure_map(map__14635);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14635__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
var more = null;
if (arguments.length > 2) {
var G__14737__i = 0, G__14737__a = new Array(arguments.length -  2);
while (G__14737__i < G__14737__a.length) {G__14737__a[G__14737__i] = arguments[G__14737__i + 2]; ++G__14737__i;}
  more = new cljs.core.IndexedSeq(G__14737__a,0,null);
} 
...
var G__14740 = null;
if (arguments.length > 2) {
var G__14741__i = 0, G__14741__a = new Array(arguments.length -  2);
while (G__14741__i < G__14741__a.length) {G__14741__a[G__14741__i] = arguments[G__14741__i + 2]; ++G__14741__i;}
G__14740 = new cljs.core.IndexedSeq(G__14741__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__14740);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14642__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__14643 = u(y);
var map__14643__$1 = cljs.core.__destructure_map(map__14643);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14643__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null,m1,m2)));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3 = (function() { 
var G__14743__delegate = function (x,y,more){
...
var G__14743 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
...
while (G__14744__i < G__14744__a.length) {G__14744__a[G__14744__i] = arguments[G__14744__i + 2]; ++G__14744__i;}
  more = new cljs.core.IndexedSeq(G__14744__a,0,null);
} 
return G__14743__delegate.call(this,x,y,more);};
G__14743.cljs$lang$maxFixedArity = 2;
...
return G__14743__delegate(x,y,more);
});
...
G__14746 = new cljs.core.IndexedSeq(G__14747__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__14746);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
