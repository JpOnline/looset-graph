...
return [(function (){var pred__12387 = cljs.core.instance_QMARK_;
var expr__12388 = reactive_val;
if(cljs.core.truth_((pred__12387.cljs$core$IFn$_invoke$arity$2 ? pred__12387.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.RAtom,expr__12388) : pred__12387.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.RAtom,expr__12388)))){
return "ra";
} else {
if(cljs.core.truth_((pred__12387.cljs$core$IFn$_invoke$arity$2 ? pred__12387.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.RCursor,expr__12388) : pred__12387.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.RCursor,expr__12388)))){
return "rc";
} else {
if(cljs.core.truth_((pred__12387.cljs$core$IFn$_invoke$arity$2 ? pred__12387.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.Reaction,expr__12388) : pred__12387.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.Reaction,expr__12388)))){
return "rx";
} else {
if(cljs.core.truth_((pred__12387.cljs$core$IFn$_invoke$arity$2 ? pred__12387.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.Track,expr__12388) : pred__12387.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.Track,expr__12388)))){
return "tr";
} else {
return "other";
}
