...
return [(function (){var pred__15339 = cljs.core.instance_QMARK_;
var expr__15340 = reactive_val;
if(cljs.core.truth_((pred__15339.cljs$core$IFn$_invoke$arity$2 ? pred__15339.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__15340) : pred__15339.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__15340)))){
return "ra";
} else {
if(cljs.core.truth_((pred__15339.cljs$core$IFn$_invoke$arity$2 ? pred__15339.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__15340) : pred__15339.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__15340)))){
return "rc";
} else {
if(cljs.core.truth_((pred__15339.cljs$core$IFn$_invoke$arity$2 ? pred__15339.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__15340) : pred__15339.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__15340)))){
return "rx";
} else {
if(cljs.core.truth_((pred__15339.cljs$core$IFn$_invoke$arity$2 ? pred__15339.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__15340) : pred__15339.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__15340)))){
return "tr";
} else {
return "other";
}
