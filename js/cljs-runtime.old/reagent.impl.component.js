...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__15735 = c;
var G__15735__$1 = (((G__15735 == null))?null:G__15735.prototype);
if((G__15735__$1 == null)){
return null;
} else {
return G__15735__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__15736 = c;
var G__15736__$1 = (((G__15736 == null))?null:G__15736.prototype);
if((G__15736__$1 == null)){
return null;
} else {
return G__15736__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__15824__delegate = function (args){
...
var or__5045__auto__ = (function (){var G__15790 = c;
var G__15790__$1 = (((G__15790 == null))?null:G__15790.constructor);
if((G__15790__$1 == null)){
return null;
} else {
return G__15790__$1.displayName;
}
})();
...
var G__15796 = c;
var G__15796__$1 = (((G__15796 == null))?null:G__15796.constructor);
if((G__15796__$1 == null)){
return null;
} else {
return G__15796__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__15799 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__15800 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__15800);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__15799);
}});
...
var c = this;
var G__15814_15830 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__15814_15830 == null)){
} else {
reagent.ratom.dispose_BANG_(G__15814_15830);
}
...
var renders_15831 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_15832 = cljs.core.first(cljs.core.vals(renders_15831));
...
if((cljs.core.count(renders_15831) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_15831))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_15832)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_15832], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__15815 = o;
reagent.impl.component.goog$module$goog$object.set(G__15815,cljs.core.name(k),v);
...
while (G__15838__i < G__15838__a.length) {G__15838__a[G__15838__i] = arguments[G__15838__i + 0]; ++G__15838__i;}
  args = new cljs.core.IndexedSeq(G__15838__a,0,null);
} 
...
var args = cljs.core.seq(arglist__15839);
...
var _STAR_current_component_STAR__orig_val__15816 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__15817 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__15817);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__15816);
}});
...
var vec__15818 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15818,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15818,(1),null);
...
var G__15821 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__15821 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__15821);
}
});
}),[]);
