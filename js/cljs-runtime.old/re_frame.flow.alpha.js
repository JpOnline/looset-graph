...
re_frame.flow.alpha.input_ids = (function re_frame$flow$alpha$input_ids(p__29964){
var map__29966 = p__29964;
var map__29966__$1 = cljs.core.__destructure_map(map__29966);
var inputs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29966__$1,new cljs.core.Keyword(null,"inputs","inputs",865803858));
var live_inputs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29966__$1,new cljs.core.Keyword(null,"live-inputs","live-inputs",1350889395));
return cljs.core.vec(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.remove.cljs$core$IFn$_invoke$arity$1(re_frame.flow.alpha.db_path_QMARK_),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__29959_SHARP_){
var or__5045__auto__ = new cljs.core.Keyword("re-frame.flow.alpha","flow<-","re-frame.flow.alpha/flow<-",1540916150).cljs$core$IFn$_invoke$arity$1(p1__29959_SHARP_);
...
re_frame.flow.alpha.stale_in_flows = (function re_frame$flow$alpha$stale_in_flows(flows,p__29981){
var map__29982 = p__29981;
var map__29982__$1 = cljs.core.__destructure_map(map__29982);
var inputs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29982__$1,new cljs.core.Keyword(null,"inputs","inputs",865803858));
return cljs.core.reduce_kv((function (m,k,p__29990){
var map__29993 = p__29990;
var map__29993__$1 = cljs.core.__destructure_map(map__29993);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29993__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var G__29994 = m;
if(cljs.core.contains_QMARK_(cljs.core.set(cljs.core.vals(inputs)),path)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__29994,k,path);
} else {
return G__29994;
}
}),cljs.core.PersistentArrayMap.EMPTY,flows);
});
re_frame.flow.alpha.stale_out_flows = (function re_frame$flow$alpha$stale_out_flows(flows,p__29997){
var map__29998 = p__29997;
var map__29998__$1 = cljs.core.__destructure_map(map__29998);
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29998__$1,new cljs.core.Keyword(null,"path","path",-188191168));
return cljs.core.reduce_kv((function (m,k,p__29999){
var map__30000 = p__29999;
var map__30000__$1 = cljs.core.__destructure_map(map__30000);
var inputs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30000__$1,new cljs.core.Keyword(null,"inputs","inputs",865803858));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__30003,k,bad_inputs);
} else {
return G__30003;
}
}),cljs.core.PersistentArrayMap.EMPTY,flows);
});
re_frame.flow.alpha.validate_inputs = (function re_frame$flow$alpha$validate_inputs(p__30006){
var map__30007 = p__30006;
var map__30007__$1 = cljs.core.__destructure_map(map__30007);
var inputs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30007__$1,new cljs.core.Keyword(null,"inputs","inputs",865803858));
var seq__30012 = cljs.core.seq(inputs);
var chunk__30014 = null;
var count__30015 = (0);
var i__30016 = (0);
while(true){
if((i__30016 < count__30015)){
var vec__30037 = chunk__30014.cljs$core$IIndexed$_nth$arity$2(null,i__30016);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30037,(0),null);
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30037,(1),null);
...
var G__30188 = seq__30012;
var G__30189 = chunk__30014;
var G__30190 = count__30015;
var G__30191 = (i__30016 + (1));
seq__30012 = G__30188;
chunk__30014 = G__30189;
count__30015 = G__30190;
i__30016 = G__30191;
continue;
} else {
var G__30192 = seq__30012;
var G__30193 = chunk__30014;
var G__30194 = count__30015;
var G__30195 = (i__30016 + (1));
seq__30012 = G__30192;
chunk__30014 = G__30193;
count__30015 = G__30194;
i__30016 = G__30195;
continue;
}
} else {
var temp__5804__auto__ = cljs.core.seq(seq__30012);
if(temp__5804__auto__){
var seq__30012__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__30012__$1)){
var c__5568__auto__ = cljs.core.chunk_first(seq__30012__$1);
var G__30196 = cljs.core.chunk_rest(seq__30012__$1);
var G__30197 = c__5568__auto__;
var G__30198 = cljs.core.count(c__5568__auto__);
var G__30199 = (0);
seq__30012 = G__30196;
chunk__30014 = G__30197;
count__30015 = G__30198;
i__30016 = G__30199;
continue;
} else {
var vec__30052 = cljs.core.first(seq__30012__$1);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30052,(0),null);
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30052,(1),null);
if(cljs.core.not(cljs.core.some_fn.cljs$core$IFn$_invoke$arity$2(re_frame.flow.alpha.db_path_QMARK_,re_frame.flow.alpha.flow_LT___QMARK_)(input))){
throw (new Error("bad input"));


var G__30200 = cljs.core.next(seq__30012__$1);
var G__30201 = null;
var G__30202 = (0);
var G__30203 = (0);
seq__30012 = G__30200;
chunk__30014 = G__30201;
count__30015 = G__30202;
i__30016 = G__30203;
continue;
} else {
var G__30204 = cljs.core.next(seq__30012__$1);
var G__30205 = null;
var G__30206 = (0);
var G__30207 = (0);
seq__30012 = G__30204;
chunk__30014 = G__30205;
count__30015 = G__30206;
i__30016 = G__30207;
continue;
}
}
...
var warn_ins = (function (p__30057){
var vec__30058 = p__30057;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30058,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30058,(1),null);
...
var warn_outs = (function (p__30061){
var vec__30062 = p__30061;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30062,(0),null);
var inputs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30062,(1),null);
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__30065){
var vec__30066 = p__30065;
var input_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30066,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30066,(1),null);
...
re_frame.flow.alpha.do_effect = (function re_frame$flow$alpha$do_effect(p__30128){
...
var fexpr__30133 = re_frame.registrar.get_handler.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"fx","fx",-1237829572),k,false);
return (fexpr__30133.cljs$core$IFn$_invoke$arity$1 ? fexpr__30133.cljs$core$IFn$_invoke$arity$1(v) : fexpr__30133.call(null,v));
});
...
var map__30136__$1 = cljs.core.__destructure_map(map__30136);
var ctx = map__30136__$1;
var map__30137 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30136__$1,new cljs.core.Keyword(null,"effects","effects",-282369292));
var map__30137__$1 = cljs.core.__destructure_map(map__30137);
var effects = map__30137__$1;
var fx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30137__$1,new cljs.core.Keyword(null,"fx","fx",-1237829572));
...
var G__30148 = input;
var G__30148__$1 = (((G__30148 == null))?null:new cljs.core.Keyword("re-frame.flow.alpha","flow<-","re-frame.flow.alpha/flow<-",1540916150).cljs$core$IFn$_invoke$arity$1(G__30148));
var G__30148__$2 = (((G__30148__$1 == null))?null:re_frame.flow.alpha.lookup(G__30148__$1));
var G__30148__$3 = (((G__30148__$2 == null))?null:new cljs.core.Keyword(null,"path","path",-188191168).cljs$core$IFn$_invoke$arity$1(G__30148__$2));
if((G__30148__$3 == null)){
return null;
} else {
return (re_frame.flow.alpha.resolve_input.cljs$core$IFn$_invoke$arity$2 ? re_frame.flow.alpha.resolve_input.cljs$core$IFn$_invoke$arity$2(db,G__30148__$3) : re_frame.flow.alpha.resolve_input.call(null,db,G__30148__$3));
}
}
});
...
re_frame.flow.alpha.run = (function re_frame$flow$alpha$run(ctx,p__30154){
var map__30155 = p__30154;
var map__30155__$1 = cljs.core.__destructure_map(map__30155);
var flow = map__30155__$1;
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30155__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var cleanup = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30155__$1,new cljs.core.Keyword(null,"cleanup","cleanup",1045776959));
var live_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30155__$1,new cljs.core.Keyword(null,"live?","live?",-1539352230));
var inputs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30155__$1,new cljs.core.Keyword(null,"inputs","inputs",865803858));
var live_inputs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30155__$1,new cljs.core.Keyword(null,"live-inputs","live-inputs",1350889395));
var output = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30155__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30155__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var cleared_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30155__$1,new cljs.core.Keyword("re-frame.flow.alpha","cleared?","re-frame.flow.alpha/cleared?",1524733548));
var map__30161 = cljs.core.meta(flow);
var map__30161__$1 = cljs.core.__destructure_map(map__30161);
var new_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30161__$1,new cljs.core.Keyword("re-frame.flow.alpha","new?","re-frame.flow.alpha/new?",1214332038));
...
var new_db = (function (){var G__30166 = bardo;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"live","live",-1610148039),new cljs.core.Keyword(null,"live","live",-1610148039)], null),G__30166)){
var G__30170 = db;
if(dirty_QMARK_){
return cljs.core.assoc_in(G__30170,path,(output.cljs$core$IFn$_invoke$arity$1 ? output.cljs$core$IFn$_invoke$arity$1(id__GT_in) : output.call(null,id__GT_in)));
} else {
return G__30170;
}
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"live","live",-1610148039),new cljs.core.Keyword(null,"dead","dead",-1946604091)], null),G__30166)){
return (cleanup.cljs$core$IFn$_invoke$arity$2 ? cleanup.cljs$core$IFn$_invoke$arity$2(db,path) : cleanup.call(null,db,path));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"dead","dead",-1946604091),new cljs.core.Keyword(null,"live","live",-1610148039)], null),G__30166)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"new","new",-2085437848),new cljs.core.Keyword(null,"live","live",-1610148039)], null),G__30166)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"live","live",-1610148039),new cljs.core.Keyword(null,"cleared","cleared",-1267667336)], null),G__30166)){
return (cleanup.cljs$core$IFn$_invoke$arity$2 ? cleanup.cljs$core$IFn$_invoke$arity$2(db,path) : cleanup.call(null,db,path));
} else {
return null;
...
return re_frame.interceptor.assoc_effect(G__30171,new cljs.core.Keyword(null,"db","db",993250759),new_db);
} else {
return G__30171;
}
});
re_frame.flow.alpha.with_cleared = (function re_frame$flow$alpha$with_cleared(m){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(m,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__30175){
var vec__30176 = p__30175;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30176,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30176,(1),null);
...
var ctx = map__30183__$1;
var map__30184 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30183__$1,new cljs.core.Keyword(null,"effects","effects",-282369292));
var map__30184__$1 = cljs.core.__destructure_map(map__30184);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30184__$1,new cljs.core.Keyword(null,"db","db",993250759));
