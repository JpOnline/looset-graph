...
var map__21681 = cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.app-db.subs","popup-menu","day8.re-frame-10x.panels.app-db.subs/popup-menu",-100095659)], null)));
var map__21681__$1 = cljs.core.__destructure_map(map__21681);
var vec__21682 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21681__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var left = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21682,(0),null);
var top = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21682,(1),null);
var showing_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21681__$1,new cljs.core.Keyword(null,"showing?","showing?",2094921488));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21681__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21681__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var data_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21681__$1,new cljs.core.Keyword(null,"data-path","data-path",674802181));
...
var G__21690_21749 = data_path;
if((G__21690_21749 == null)){
} else {
day8.re_frame_10x.fx.clipboard.copy_BANG_(G__21690_21749);
}
...
var G__21695_21754 = data;
var G__21695_21755__$1 = (((G__21695_21754 == null))?null:cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(G__21695_21754,cljs.core.drop.cljs$core$IFn$_invoke$arity$2(cljs.core.count(path),cljs.core.pop(data_path))));
if((G__21695_21755__$1 == null)){
} else {
day8.re_frame_10x.fx.clipboard.copy_BANG_(G__21695_21755__$1);
}
