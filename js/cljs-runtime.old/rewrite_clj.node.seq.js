...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k21423,else__5346__auto__){
var self__ = this;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__21484){
var vec__21486 = p__21484;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21486,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21486,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__21422){
var self__ = this;
var G__21422__$1 = this;
return (new cljs.core.RecordIter((0),G__21422__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"format-string","format-string",832187437),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this21428,other21429){
var self__ = this;
var this21428__$1 = this;
return (((!((other21429 == null)))) && ((((this21428__$1.constructor === other21429.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21428__$1.tag,other21429.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21428__$1.format_string,other21429.format_string)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21428__$1.wrap_length,other21429.wrap_length)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21428__$1.seq_fn,other21429.seq_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21428__$1.children,other21429.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21428__$1.__extmap,other21429.__extmap)))))))))))))));
}));
...
var self__ = this;
var _node__$1 = this;
var G__21555 = rewrite_clj.node.protocols.sexprs.cljs$core$IFn$_invoke$arity$2(self__.children,opts);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__21555) : self__.seq_fn.call(null,G__21555));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k21423){
var self__ = this;
var this__5350__auto____$1 = this;
var G__21582 = k21423;
var G__21582__$1 = (((G__21582 instanceof cljs.core.Keyword))?G__21582.fqn:null);
switch (G__21582__$1) {
case "tag":
case "format-string":
case "wrap-length":
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__21422){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__21583 = cljs.core.keyword_identical_QMARK_;
var expr__21584 = k__5352__auto__;
if(cljs.core.truth_((pred__21583.cljs$core$IFn$_invoke$arity$2 ? pred__21583.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__21584) : pred__21583.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__21584)))){
return (new rewrite_clj.node.seq.SeqNode(G__21422,self__.format_string,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__21583.cljs$core$IFn$_invoke$arity$2 ? pred__21583.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"format-string","format-string",832187437),expr__21584) : pred__21583.call(null,new cljs.core.Keyword(null,"format-string","format-string",832187437),expr__21584)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__21422,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__21583.cljs$core$IFn$_invoke$arity$2 ? pred__21583.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__21584) : pred__21583.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__21584)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,G__21422,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__21583.cljs$core$IFn$_invoke$arity$2 ? pred__21583.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__21584) : pred__21583.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__21584)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,G__21422,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__21583.cljs$core$IFn$_invoke$arity$2 ? pred__21583.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__21584) : pred__21583.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__21584)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,self__.seq_fn,G__21422,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__21422),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__21422){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,self__.seq_fn,self__.children,G__21422,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__21439){
var extmap__5385__auto__ = (function (){var G__21608 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__21439,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"format-string","format-string",832187437),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
...
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__21439),new cljs.core.Keyword(null,"format-string","format-string",832187437).cljs$core$IFn$_invoke$arity$1(G__21439),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__21439),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__21439),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__21439),null,cljs.core.not_empty(extmap__5385__auto__),null));
});

rewrite_clj.node.protocols.make_printable_BANG_(rewrite_clj.node.seq.SeqNode);
var list_node_seq_fn_21666 = (function (p1__21613_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__21613_SHARP_);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),"(%s)",(2),list_node_seq_fn_21666,children);
});
/**
...
var map_seq_fn_21668 = (function (p1__21627_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__21627_SHARP_);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),"{%s}",(2),map_seq_fn_21668,children);
});
