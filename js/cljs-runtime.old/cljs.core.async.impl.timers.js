...
var i_13926 = (self__.level + (1));
while(true){
if((i_13926 <= (new_level + (1)))){
(update[i_13926] = self__.header);

var G__13929 = (i_13926 + (1));
i_13926 = G__13929;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_13930 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_13930[i]));
} else {
x__$2.forward.push((((i < links_13930.length))?(links_13930[i]):null));
}

if((i < links_13930.length)){
(links_13930[i] = x__$2);
} else {
links_13930.push(x__$2);
}
...
var i_13965 = (0);
while(true){
if((i_13965 <= self__.level)){
var links_13966 = (update[i_13965]).forward;
if((x__$1 === (((i_13965 < links_13966.length))?(links_13966[i_13965]):null))){
(links_13966[i_13965] = (x__$1.forward[i_13965]));

var G__13974 = (i_13965 + (1));
i_13965 = G__13974;
continue;
} else {
var G__13976 = (i_13965 + (1));
i_13965 = G__13976;
continue;
}
} else {
