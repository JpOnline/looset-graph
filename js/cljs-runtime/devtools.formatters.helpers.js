...
var G__14297 = devtools.prefs.pref(v);
v = G__14297;
continue;
} else {
return v;
...
}catch (e14260){var _e__10210__auto__ = e14260;
return false;
}})();
...
}catch (e14262){var _e__10210__auto__ = e14262;
return false;
}})();
...
}catch (e14264){var _e__10210__auto__ = e14264;
return false;
}}
}
});
...
var vec__14269 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14269,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14269,(1),null);
...
return cljs.core.some((function (p1__14273_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__14273_SHARP_);
}),template);
});
