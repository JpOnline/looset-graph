...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","root","day8.re-frame-10x.panels.event.subs/root",-909264964),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p__26205,_){
var map__26206 = p__26205;
var map__26206__$1 = cljs.core.__destructure_map(map__26206);
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26206__$1,new cljs.core.Keyword(null,"code","code",1586293142));
return code;
})], 0));
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","trace-id-for-epoch","day8.re-frame-10x.panels.event.subs/trace-id-for-epoch",728519790),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","code-for-epoch","day8.re-frame-10x.panels.event.subs/code-for-epoch",1888261905)], null),(function (p__26255,_){
var map__26256 = p__26255;
var map__26256__$1 = cljs.core.__destructure_map(map__26256);
var trace_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26256__$1,new cljs.core.Keyword(null,"trace-id","trace-id",681947249));
return trace_id;
})], 0));
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","form-for-epoch","day8.re-frame-10x.panels.event.subs/form-for-epoch",-1506248120),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","code-for-epoch","day8.re-frame-10x.panels.event.subs/code-for-epoch",1888261905)], null),(function (p__26257,_){
var map__26258 = p__26257;
var map__26258__$1 = cljs.core.__destructure_map(map__26258);
var form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26258__$1,new cljs.core.Keyword(null,"form","form",-1624062471));
return form;
})], 0));
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","code-open?","day8.re-frame-10x.panels.event.subs/code-open?",1956666991),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","root","day8.re-frame-10x.panels.event.subs/root",-909264964)], null),(function (p__26267,_){
var map__26268 = p__26267;
var map__26268__$1 = cljs.core.__destructure_map(map__26268);
var code_open_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26268__$1,new cljs.core.Keyword(null,"code-open?","code-open?",1228336744));
return code_open_QMARK_;
})], 0));
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","highlighted-form","day8.re-frame-10x.panels.event.subs/highlighted-form",1402683478),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","root","day8.re-frame-10x.panels.event.subs/root",-909264964)], null),(function (p__26274,_){
var map__26276 = p__26274;
var map__26276__$1 = cljs.core.__destructure_map(map__26276);
var highlighted_form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26276__$1,new cljs.core.Keyword(null,"highlighted-form","highlighted-form",-1255288753));
...
var G__26411 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,i_s);
var G__26412 = (i_s + (1));
var G__26413 = (i_s_SINGLEQUOTE_ + (1));
v = G__26411;
i_s = G__26412;
i_s_SINGLEQUOTE_ = G__26413;
continue;
} else {
var G__26414 = v;
var G__26415 = (i_s + (1));
var G__26416 = i_s_SINGLEQUOTE_;
v = G__26414;
i_s = G__26415;
i_s_SINGLEQUOTE_ = G__26416;
continue;
...
var vec__26343 = day8.re_frame_10x.panels.event.subs.collapse_whitespace_and_index(form_str);
var form_str__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26343,(0),null);
var reindex = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26343,(1),null);
...
var vec__26354 = result;
var vec__26357 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26354,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26357,(0),null);
var pre_match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26357,(1),null);
var matched_form = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26357,(2),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26354,(1),null);
...
var start = (function (){var G__26364 = form_str__$1;
var G__26364__$1 = (((G__26364 == null))?null:clojure.string.index_of.cljs$core$IFn$_invoke$arity$2(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([search_str], 0)),G__26364));
if((G__26364__$1 == null)){
return null;
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(reindex,G__26364__$1);
}
})();
...
var end = (function (){var G__26365 = start;
var G__26365__$1 = (((G__26365 == null))?null:(length + G__26365));
if((G__26365__$1 == null)){
return null;
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(reindex,G__26365__$1);
}
})();
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","highlighted-form-bounds","day8.re-frame-10x.panels.event.subs/highlighted-form-bounds",-992076813),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","highlighted-form","day8.re-frame-10x.panels.event.subs/highlighted-form",1402683478)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","zprint-form-for-epoch","day8.re-frame-10x.panels.event.subs/zprint-form-for-epoch",279472373)], null),(function (p__26370,_){
var vec__26372 = p__26370;
var highlighted_form = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26372,(0),null);
var form = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26372,(1),null);
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","highlighted?","day8.re-frame-10x.panels.event.subs/highlighted?",-173027178),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","zprint-form-for-epoch","day8.re-frame-10x.panels.event.subs/zprint-form-for-epoch",279472373)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","highlighted-form-bounds","day8.re-frame-10x.panels.event.subs/highlighted-form-bounds",-992076813)], null),(function (p__26377,p__26378){
var vec__26390 = p__26377;
var zp = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26390,(0),null);
var vec__26393 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26390,(1),null);
var left_bound = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26393,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26393,(1),null);
var vec__26396 = p__26378;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26396,(0),null);
var vec__26399 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26396,(1),null);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26399,(0),null);
var char$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26399,(1),null);
if((left_bound > (0))){
var line__$1 = (line - (1));
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","show-all-code?","day8.re-frame-10x.panels.event.subs/show-all-code?",1829719373),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","root","day8.re-frame-10x.panels.event.subs/root",-909264964)], null),(function (p__26402,_){
var map__26403 = p__26402;
var map__26403__$1 = cljs.core.__destructure_map(map__26403);
var show_all_code_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26403__$1,new cljs.core.Keyword(null,"show-all-code?","show-all-code?",159571286));
return show_all_code_QMARK_;
})], 0));
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","repl-msg-state","day8.re-frame-10x.panels.event.subs/repl-msg-state",1012951853),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","root","day8.re-frame-10x.panels.event.subs/root",-909264964)], null),(function (p__26404,_){
var map__26405 = p__26404;
var map__26405__$1 = cljs.core.__destructure_map(map__26405);
var repl_msg_state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26405__$1,new cljs.core.Keyword(null,"repl-msg-state","repl-msg-state",-522274040));
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","max-column-width","day8.re-frame-10x.panels.event.subs/max-column-width",-1175866341),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.settings.subs","window-width-rounded","day8.re-frame-10x.panels.settings.subs/window-width-rounded",193095108),(100)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.event.subs","single-character-width","day8.re-frame-10x.panels.event.subs/single-character-width",1463629101)], null),(function (p__26406,_){
var vec__26407 = p__26406;
var window_width = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26407,(0),null);
var char_width = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26407,(1),null);
