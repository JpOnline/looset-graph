...
return [(function (){var pred__12570 = cljs.core.instance_QMARK_;
var expr__12571 = reactive_val;
if(cljs.core.truth_((pred__12570.cljs$core$IFn$_invoke$arity$2 ? pred__12570.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.RAtom,expr__12571) : pred__12570.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.RAtom,expr__12571)))){
return "ra";
} else {
if(cljs.core.truth_((pred__12570.cljs$core$IFn$_invoke$arity$2 ? pred__12570.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.RCursor,expr__12571) : pred__12570.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.RCursor,expr__12571)))){
return "rc";
} else {
if(cljs.core.truth_((pred__12570.cljs$core$IFn$_invoke$arity$2 ? pred__12570.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.Reaction,expr__12571) : pred__12570.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.Reaction,expr__12571)))){
return "rx";
} else {
if(cljs.core.truth_((pred__12570.cljs$core$IFn$_invoke$arity$2 ? pred__12570.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.Track,expr__12571) : pred__12570.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.Track,expr__12571)))){
return "tr";
} else {
return "other";
}
