...
var G__12247 = o;
day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.goog$module$goog$object.set(G__12247,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.cached_prop_name(k),(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__12304__i < G__12304__a.length) {G__12304__a[G__12304__i] = arguments[G__12304__i + 0]; ++G__12304__i;}
  args = new cljs.core.IndexedSeq(G__12304__a,0,null);
} 
...
var G__12248 = o;
day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.goog$module$goog$object.set(G__12248,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.cached_custom_prop_name(k),day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__12306__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__12307__i < G__12307__a.length) {G__12307__a[G__12307__i] = arguments[G__12307__i + 0]; ++G__12307__i;}
  args = new cljs.core.IndexedSeq(G__12307__a,0,null);
} 
return G__12306__delegate.call(this,args);};
G__12306.cljs$lang$maxFixedArity = 0;
G__12306.cljs$lang$applyTo = (function (arglist__12308){
var args = cljs.core.seq(arglist__12308);
return G__12306__delegate(args);
});
...
var G__12249 = props;
var G__12249__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12249,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__12249);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12249__$1,new cljs.core.Keyword(null,"class","class",-2030961996),day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.set_id_class((function (){var G__12250 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12250,new cljs.core.Keyword(null,"class","class",-2030961996),day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__12250;
}
})(),id_class);
...
var G__12251 = (cljs.core.count(argv) - first_child);
switch (G__12251) {
case (0):
...
var vec__12252 = cljs.core.next(cljs.core.re_matches(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12252,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12252,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12252,(2),null);
...
var temp__5808__auto___12318 = day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___12318 == null)){
} else {
var key_12319 = temp__5808__auto___12318;
...
var temp__5808__auto___12320 = day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___12320 == null)){
} else {
var key_12321 = temp__5808__auto___12320;
(jsprops.key = key_12321);
}
...
var temp__5808__auto___12326 = day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___12326 == null)){
} else {
var key_12327 = temp__5808__auto___12326;
(jsprops.key = key_12327);
}
...
var temp__5808__auto___12334 = day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___12334 == null)){
} else {
var key_12335 = temp__5808__auto___12334;
(jsprops.key = key_12335);
}
...
var temp__5808__auto___12340 = day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___12340 == null)){
} else {
var key_12341 = temp__5808__auto___12340;
(jsprops.key = key_12341);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12270_SHARP_){
return day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.protocols.as_element(compiler,p1__12270_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__12271 = day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.check_derefs((function (){
return day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12271,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12271,(1),null);
...
break;
default:
var G__12353 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__12354 = compiler;
v = G__12353;
compiler = G__12354;
continue;
...
*/
day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template12299 = (function (opts,id,fn_to_element,parse_fn,meta12300){
this.opts = opts;
this.id = id;
...
(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template12299.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12301,meta12300__$1){
var self__ = this;
var _12301__$1 = this;
return (new day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template12299(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta12300__$1));
}));

(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template12299.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12301){
var self__ = this;
var _12301__$1 = this;
return self__.meta12300;
}));

(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template12299.prototype.day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template12299.prototype.day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template12299.prototype.day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template12299.prototype.day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template12299.prototype.day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
...
(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template12299.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta12300","meta12300",127207746,null)], null);
}));

(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template12299.cljs$lang$type = true);

(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template12299.cljs$lang$ctorStr = "day8.re-frame-10x.inlined-deps.reagent.v1v2v0.reagent.impl.template/t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template12299");

(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template12299.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"day8.re-frame-10x.inlined-deps.reagent.v1v2v0.reagent.impl.template/t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template12299");
}));

/**
 * Positional factory function for day8.re-frame-10x.inlined-deps.reagent.v1v2v0.reagent.impl.template/t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template12299.
 */
day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.__GT_t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template12299 = (function day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template$__GT_t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template12299(opts,id,fn_to_element,parse_fn,meta12300){
return (new day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template12299(opts,id,fn_to_element,parse_fn,meta12300));
});
...
return (new day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template12299(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
