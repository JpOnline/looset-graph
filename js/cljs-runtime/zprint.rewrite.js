...
var G__27421 = rewrite_clj.zip.next(n);
loc = G__27421;
continue;
} else {
var G__27422 = rewrite_clj.zip.next(loc);
loc = G__27422;
continue;
}
} else {
var G__27423 = rewrite_clj.zip.next(loc);
loc = G__27423;
continue;
}
}
...
return rewrite_clj.zip.replace(zloc,rewrite_clj.zip.root(zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__27295 = zloc;
var G__27295__$1 = (((G__27295 == null))?null:rewrite_clj.zip.node(G__27295));
if((G__27295__$1 == null)){
return null;
} else {
return rewrite_clj.zip.of_node_STAR_.cljs$core$IFn$_invoke$arity$1(G__27295__$1);
}
})())));
});
/**
...
var G__27464 = rewrite_clj.zip.down(nloc);
nloc = G__27464;
continue;
}
break;
...
var G__27466 = rewrite_clj.zip.right(nloc);
var G__27467 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__27466;
out = G__27467;
continue;
} else {
...
var G__27469 = rewrite_clj.zip.right(replaced_loc);
var G__27470 = cljs.core.next(new_loc);
var G__27471 = replaced_loc;
nloc = G__27469;
new_loc = G__27470;
last_loc = G__27471;
continue;
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__27386_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.tag(p1__27386_SHARP_),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.sexpr(p1__27386_SHARP_),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
