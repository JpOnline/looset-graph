 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.compression.token_fn = (function day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$compression$token_fn(p__13834){
var vec__13835 = p__13834;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13835,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13835,(1),null);
return (function (s){
...
var len__5769__auto___13893 = arguments.length;
var i__5770__auto___13894 = (0);
while(true){
if((i__5770__auto___13894 < len__5769__auto___13893)){
args__5775__auto__.push((arguments[i__5770__auto___13894]));

var G__13895 = (i__5770__auto___13894 + (1));
i__5770__auto___13894 = G__13895;
continue;
} else {
}
break;
...
return (function (s){
return cljs.core.some((function (p1__13843_SHARP_){
return (p1__13843_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__13843_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__13843_SHARP_.call(null,s));
}),fs);
});
}));
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq13844){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq13844));
}));
...
var map__13869 = temp__5802__auto__;
var map__13869__$1 = cljs.core.__destructure_map(map__13869);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13869__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13869__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13869__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__13901 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__13902 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__13874 = tag;
var G__13874__$1 = (((G__13874 instanceof cljs.core.Keyword))?G__13874.fqn:null);
switch (G__13874__$1) {
case "string":
return chunk;
