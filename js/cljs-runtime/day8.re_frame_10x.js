...
var width_PERCENT__27612 = ((new_window_width - x) / new_window_width);
if((width_PERCENT__27612 <= 0.9)){
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.settings.events","panel-width%","day8.re-frame-10x.panels.settings.events/panel-width%",-569115915),width_PERCENT__27612], null));
} else {
}
...
var trace = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__27577_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(trace_id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__27577_SHARP_));
...
var ignore = (function (p1__27587_SHARP_){
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"event-id","event-id",2130210178),p1__27587_SHARP_,new cljs.core.Keyword(null,"event-str","event-str",381347778),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__27587_SHARP_)], null);
});
var view = (function (p1__27589_SHARP_){
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ns","ns",441598760),p1__27589_SHARP_,new cljs.core.Keyword(null,"ns-str","ns-str",-2062616499),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__27589_SHARP_)], null);
});
var alias = (function (p__27590){
var vec__27591 = p__27590;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27591,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27591,(1),null);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,keep_vals,new cljs.core.PersistentArrayMap(null, 8, [new cljs.core.Keyword(null,"debug?","debug?",-1831756173),day8.re_frame_10x.debug_QMARK_,new cljs.core.Keyword(null,"retained-epochs","retained-epochs",1350238734),day8.re_frame_10x.history_size,new cljs.core.Keyword(null,"ignored-events","ignored-events",1738756589),(function (){var G__27594 = day8.re_frame_10x.ignored_events;
var G__27594__$1 = (((G__27594 == null))?null:(read.cljs$core$IFn$_invoke$arity$1 ? read.cljs$core$IFn$_invoke$arity$1(G__27594) : read.call(null,G__27594)));
var G__27594__$2 = (((G__27594__$1 == null))?null:cljs.core.map.cljs$core$IFn$_invoke$arity$2(ignore,G__27594__$1));
if((G__27594__$2 == null)){
return null;
} else {
return day8.re_frame_10x.tools.coll.sortable_uuid_map(G__27594__$2);
}
})(),new cljs.core.Keyword(null,"filtered-view-trace","filtered-view-trace",-901876599),(function (){var G__27595 = day8.re_frame_10x.hidden_namespaces;
var G__27595__$1 = (((G__27595 == null))?null:(read.cljs$core$IFn$_invoke$arity$1 ? read.cljs$core$IFn$_invoke$arity$1(G__27595) : read.call(null,G__27595)));
var G__27595__$2 = (((G__27595__$1 == null))?null:cljs.core.map.cljs$core$IFn$_invoke$arity$2(view,G__27595__$1));
if((G__27595__$2 == null)){
return null;
} else {
return day8.re_frame_10x.tools.coll.sortable_uuid_map(G__27595__$2);
}
})(),new cljs.core.Keyword(null,"app-db-follows-events?","app-db-follows-events?",-1566738462),day8.re_frame_10x.time_travel_QMARK_,new cljs.core.Keyword(null,"low-level-trace","low-level-trace",638447092),(function (){var G__27596 = day8.re_frame_10x.ignored_libs;
var G__27596__$1 = (((G__27596 == null))?null:(read.cljs$core$IFn$_invoke$arity$1 ? read.cljs$core$IFn$_invoke$arity$1(G__27596) : read.call(null,G__27596)));
if((G__27596__$1 == null)){
return null;
} else {
return day8.re_frame_10x.tools.coll.pred_map(G__27596__$1,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"re-frame","re-frame",-1039473033),null,new cljs.core.Keyword(null,"reagent","reagent",2131627322),null], null), null));
}
})(),new cljs.core.Keyword(null,"ns-aliases","ns-aliases",1290254821),(function (){var G__27597 = day8.re_frame_10x.ns_aliases;
var G__27597__$1 = (((G__27597 == null))?null:(read.cljs$core$IFn$_invoke$arity$1 ? read.cljs$core$IFn$_invoke$arity$1(G__27597) : read.call(null,G__27597)));
var G__27597__$2 = (((G__27597__$1 == null))?null:cljs.core.map.cljs$core$IFn$_invoke$arity$2(alias,G__27597__$1));
if((G__27597__$2 == null)){
return null;
} else {
return day8.re_frame_10x.tools.coll.sortable_uuid_map(G__27597__$2);
}
})(),new cljs.core.Keyword(null,"trace-when","trace-when",-1902271347),(function (){var G__27598 = day8.re_frame_10x.trace_when;
var G__27598__$1 = (((G__27598 == null))?null:(read.cljs$core$IFn$_invoke$arity$1 ? read.cljs$core$IFn$_invoke$arity$1(G__27598) : read.call(null,G__27598)));
if((G__27598__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__27598__$1);
}
})()], null));
})();
