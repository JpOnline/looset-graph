...
var comma_21989 = rewrite_clj.node.whitespace.whitespace_nodes(", ");
var space_21990 = rewrite_clj.node.whitespace.whitespace_node(" ");
rewrite_clj.node.coercer.map__GT_children = (function rewrite_clj$node$coercer$map__GT_children(m){
return cljs.core.vec(cljs.core.drop_last.cljs$core$IFn$_invoke$arity$2(cljs.core.count(comma_21989),cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__21959){
...
return cljs.core.list_STAR_.cljs$core$IFn$_invoke$arity$4(rewrite_clj.node.protocols.coerce(k),space_21990,rewrite_clj.node.protocols.coerce(v),comma_21989);
...
return rewrite_clj.node.coercer.node_with_meta((function (){var G__21974 = cljs.core.vec(rewrite_clj.node.whitespace.space_separated(cljs.core.map.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.coerce,sq)));
