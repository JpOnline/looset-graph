...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_16720 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_16720(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_16722 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_16722(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_16728 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_16728(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_16731 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_16731(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_16736 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_16736(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_16738 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_16738(reader);
}
});
