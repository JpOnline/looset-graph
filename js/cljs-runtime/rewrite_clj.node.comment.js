...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k20234,else__5346__auto__){
var self__ = this;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__20274){
var vec__20275 = p__20274;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20275,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20275,(1),null);
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__20233){
var self__ = this;
var G__20233__$1 = this;
return (new cljs.core.RecordIter((0),G__20233__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"s","s",1705939918)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this20235,other20236){
var self__ = this;
var this20235__$1 = this;
return (((!((other20236 == null)))) && ((((this20235__$1.constructor === other20236.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this20235__$1.prefix,other20236.prefix)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this20235__$1.s,other20236.s)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this20235__$1.__extmap,other20236.__extmap)))))))));
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k20234){
var self__ = this;
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__20233){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__20347 = cljs.core.keyword_identical_QMARK_;
var expr__20348 = k__5352__auto__;
if(cljs.core.truth_((pred__20347.cljs$core$IFn$_invoke$arity$2 ? pred__20347.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__20348) : pred__20347.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__20348)))){
return (new rewrite_clj.node.comment.CommentNode(G__20233,self__.s,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__20347.cljs$core$IFn$_invoke$arity$2 ? pred__20347.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"s","s",1705939918),expr__20348) : pred__20347.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__20348)))){
return (new rewrite_clj.node.comment.CommentNode(self__.prefix,G__20233,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.comment.CommentNode(self__.prefix,self__.s,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__20233),null));
}
}
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__20233){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.comment.CommentNode(self__.prefix,self__.s,G__20233,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.comment.map__GT_CommentNode = (function rewrite_clj$node$comment$map__GT_CommentNode(G__20238){
var extmap__5385__auto__ = (function (){var G__20372 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__20238,new cljs.core.Keyword(null,"prefix","prefix",-265908465),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"s","s",1705939918)], 0));
if(cljs.core.record_QMARK_(G__20238)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__20372);
} else {
return G__20372;
}
})();
return (new rewrite_clj.node.comment.CommentNode(new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__20238),new cljs.core.Keyword(null,"s","s",1705939918).cljs$core$IFn$_invoke$arity$1(G__20238),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
