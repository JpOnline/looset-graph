...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__13000){
var vec__13004 = p__13000;
...
var vec__13009 = clojure.data.diff(va,vb);
...
var clojure$data$EqualityPartition$equality_partition$dyn_13182 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_13182(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_13187 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_13187(a,b);
}
});
...
var fexpr__13119 = (function (){var G__13120 = clojure.data.equality_partition(a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13120__$1)].join('')));

}
})();
return (fexpr__13119.cljs$core$IFn$_invoke$arity$2 ? fexpr__13119.cljs$core$IFn$_invoke$arity$2(a,b) : fexpr__13119.call(null,a,b));
}));
/**
