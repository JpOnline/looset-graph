...
return cljs.core.keep_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__15278_SHARP_,p2__15277_SHARP_){
if(cljs.core.truth_((pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(p2__15277_SHARP_) : pred.call(null,p2__15277_SHARP_)))){
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__15287_SHARP_){
return (((beginning <= new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__15287_SHARP_))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__15287_SHARP_) <= ending)));
}));
});
/**
 ...
 */
day8.re_frame_10x.tools.coll.dissoc_in = (function day8$re_frame_10x$tools$coll$dissoc_in(m,p__15288){
var vec__15289 = p__15288;
var seq__15290 = cljs.core.seq(vec__15289);
var first__15291 = cljs.core.first(seq__15290);
var seq__15290__$1 = cljs.core.next(seq__15290);
var k = first__15291;
var ks = seq__15290__$1;
if(ks){
...
var children = (function (p1__15293_SHARP_){
if(cljs.core.coll_QMARK_(p1__15293_SHARP_)){
return cljs.core.seq(p1__15293_SHARP_);
} else {
return null;
}
});
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__15294_SHARP_){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__15294_SHARP_,cljs.core.contains_QMARK_(ks__$1,p1__15294_SHARP_)], null);
})),possible_ks);
});
