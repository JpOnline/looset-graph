...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__19732_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__19732_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__19732_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__19736){
var vec__19739 = p__19736;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19739,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19739,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__19746,s,color,element,idx){
var map__19747 = p__19746;
var map__19747__$1 = cljs.core.__destructure_map(map__19747);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19747__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19747__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19747__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__19757 = (function (){var or__5045__auto__ = color;
...
var fexpr__19756 = (function (){var G__19758 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__19758) : style_map.call(null,G__19758));
})();
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__19761){
var vec__19762 = p__19761;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19762,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19762,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19762,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__19770){
var vec__19775 = p__19770;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19775,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19775,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19775,(2),null);
...
var G__20077 = cljs.core.next(ssv);
var G__20078 = (this_ssv == null);
var G__20079 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__20080 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__20077;
doing_nil_QMARK_ = G__20078;
last_elide = G__20079;
out = G__20080;
continue;
}
...
var vec__19859 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19859,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19859,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19859,(2),null);
...
var G__20087 = cljs.core.next(remaining_cvec);
var G__20088 = new_idx;
var G__20089 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__20087;
idx = G__20088;
out = G__20089;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__19920,cursor_vec){
var vec__19921 = p__19920;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19921,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19921,(1),null);
var focus_vec = vec__19921;
...
var vec__19924 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19924,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19924,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(color_fn,p__19936){
var vec__19937 = p__19936;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19937,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19937,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__19966,existing_count){
var vec__19967 = p__19966;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19967,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19967,(1),null);
...
return cljs.core.filterv((function (p1__19960_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__19960_SHARP_))));
...
var vec__19998 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19998,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19998,(1),null);
var cvec_element = vec__19998;
if((cvec_element == null)){
var G__20124 = cljs.core.next(cvec_nl);
var G__20125 = (idx + (1));
var G__20126 = start;
var G__20127 = out;
cvec_nl = G__20124;
...
var G__20128 = cljs.core.next(cvec_nl);
var G__20129 = (idx + (1));
var G__20130 = idx;
var G__20131 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__20128;
idx = G__20129;
start = G__20130;
out = G__20131;
...
var G__20132 = cljs.core.next(cvec_nl);
var G__20133 = (idx + (1));
var G__20134 = (idx + (1));
var G__20135 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__20132;
idx = G__20133;
start = G__20134;
out = G__20135;
...
var G__20136 = cljs.core.next(cvec_nl);
var G__20137 = (idx + (1));
var G__20138 = idx;
...
var G__20140 = cljs.core.next(cvec_nl);
var G__20141 = (idx + (1));
var G__20142 = start;
var G__20143 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__20140;
idx = G__20141;
start = G__20142;
out = G__20143;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__20016_SHARP_,p2__20015_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__20015_SHARP_)){
return cljs.core.reduced(p1__20016_SHARP_);
} else {
return (p1__20016_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__20024,p__20025){
var vec__20026 = p__20024;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20026,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20026,(1),null);
var vec__20029 = p__20025;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20029,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20029,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__20052,cvec,focus_vec){
var map__20053 = p__20052;
var map__20053__$1 = cljs.core.__destructure_map(map__20053);
var options = map__20053__$1;
var map__20054 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20053__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__20054__$1 = cljs.core.__destructure_map(map__20054);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20054__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20054__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20054__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__20051_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__20051_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
