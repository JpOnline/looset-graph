...
var G__24000 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(zloc_n0) : f.call(null,zloc_n0));
var G__24000__$1 = (((G__24000 == null))?null:cljs.core.iterate((function (loc){
...
var G__24000__$2 = (((G__24000__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__24000__$1));
var G__24000__$3 = (((G__24000__$2 == null))?null:cljs.core.last(G__24000__$2));
if((G__24000__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__24000__$3);
}
} else {
return zloc;
}
...
var G__24060 = rewrite_clj.zip.move.right(new_zloc_map_value);
var G__24061 = rewrite_clj.zip.move.up(new_zloc_map_value);
loc = G__24060;
parent = G__24061;
continue;
} else {
var G__24062 = rewrite_clj.zip.move.right(zloc_map_value);
var G__24063 = parent;
loc = G__24062;
parent = G__24063;
continue;
...
var G__24068 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(zloc_map_key));
var G__24069 = rewrite_clj.zip.move.up(zloc_map_key);
loc = G__24068;
parent = G__24069;
continue;
} else {
var G__24070 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__24071 = parent;
loc = G__24070;
parent = G__24071;
continue;
...
var G__24033 = zloc;
var G__24033__$1 = (((G__24033 == null))?null:rewrite_clj.zip.move.down(G__24033));
var G__24033__$2 = (((G__24033__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__24033__$1,k));
if((G__24033__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__24033__$2);
}
} else {
if(rewrite_clj.zip.seqz.namespaced_map_QMARK_(zloc)){
var G__24039 = zloc;
var G__24039__$1 = (((G__24039 == null))?null:rewrite_clj.zip.move.down(G__24039));
var G__24039__$2 = (((G__24039__$1 == null))?null:rewrite_clj.zip.move.rightmost(G__24039__$1));
var G__24039__$3 = (((G__24039__$2 == null))?null:rewrite_clj.zip.move.down(G__24039__$2));
var G__24039__$4 = (((G__24039__$3 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__24039__$3,k));
if((G__24039__$4 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__24039__$4);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__24041 = rewrite_clj.zip.move.down(zloc);
var G__24041__$1 = (((G__24041 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__24041));
if((G__24041__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__24041__$1);
}
})(),k);
