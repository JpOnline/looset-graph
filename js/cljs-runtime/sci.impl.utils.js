...
var map__26034 = cljs.core.meta(iobj);
var map__26034__$1 = cljs.core.__destructure_map(map__26034);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26034__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26034__$1,new cljs.core.Keyword(null,"column","column",2078222095));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__26034__$1,new cljs.core.Keyword(null,"file","file",-1269645878),cljs.core.deref(sci.impl.utils.current_file));
...
var map__26054 = (function (){var or__5045__auto__ = stack;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
var G__26055 = env;
var G__26055__$1 = (((G__26055 == null))?null:cljs.core.deref(G__26055));
var G__26055__$2 = (((G__26055__$1 == null))?null:new cljs.core.Keyword("sci.impl","callstack","sci.impl/callstack",-1621010557).cljs$core$IFn$_invoke$arity$1(G__26055__$1));
var G__26055__$3 = (((G__26055__$2 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__26055__$2,id));
var G__26055__$4 = (((G__26055__$3 == null))?null:cljs.core.deref(G__26055__$3));
var G__26055__$5 = (((G__26055__$4 == null))?null:cljs.core.last(G__26055__$4));
if((G__26055__$5 == null)){
return null;
} else {
return cljs.core.meta(G__26055__$5);
}
}
})();
var map__26054__$1 = cljs.core.__destructure_map(map__26054);
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26054__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26054__$1,new cljs.core.Keyword(null,"column","column",2078222095));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26054__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
var new_exception = (function (){var new_d = (function (){var G__26062 = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword("sci","error","sci/error",-979082803),new cljs.core.Keyword(null,"line","line",212345235),line,new cljs.core.Keyword(null,"column","column",2078222095),column,new cljs.core.Keyword(null,"message","message",-406056002),ex_msg__$1,new cljs.core.Keyword("sci.impl","callstack","sci.impl/callstack",-1621010557),st,new cljs.core.Keyword(null,"file","file",-1269645878),file], null);
if(cljs.core.truth_(phase)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26062,new cljs.core.Keyword(null,"phase","phase",575722892),phase);
} else {
return G__26062;
}
})();
...
var len__5769__auto___26168 = arguments.length;
var i__5770__auto___26169 = (0);
while(true){
if((i__5770__auto___26169 < len__5769__auto___26168)){
args__5775__auto__.push((arguments[i__5770__auto___26169]));

var G__26173 = (i__5770__auto___26169 + (1));
i__5770__auto___26169 = G__26173;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.utils.vary_meta_STAR_.cljs$lang$applyTo = (function (seq26068){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26069,G__26070,seq26068__$2);
}));

sci.impl.utils.strip_core_ns = (function sci$impl$utils$strip_core_ns(sym){
var G__26083 = cljs.core.namespace(sym);
switch (G__26083) {
case "clojure.core":
case "cljs.core":
...
var fexpr__26093 = cljs.core.deref(sci.impl.utils.eval_form_state);
return (fexpr__26093.cljs$core$IFn$_invoke$arity$2 ? fexpr__26093.cljs$core$IFn$_invoke$arity$2(sci_ctx,form) : fexpr__26093.call(null,sci_ctx,form));
});
/**
...
return cljs.core.cons(run,(function (){var G__26098 = pred;
var G__26099 = (new cljs.core.LazySeq(null,(function (){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2(cljs.core.count(run),s);
}),null,null));
return (sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2 ? sci.impl.utils.split_when.cljs$core$IFn$_invoke$arity$2(G__26098,G__26099) : sci.impl.utils.split_when.call(null,G__26098,G__26099));
})());
} else {
return null;
}
...
var G__26188 = cljs.core.next(params__$1);
var G__26189 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new_params,cljs.core.first(params__$1));
var G__26190 = lets;
params__$1 = G__26188;
new_params = G__26189;
lets = G__26190;
...
var G__26191 = cljs.core.next(params__$1);
var G__26192 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new_params,gparam);
var G__26193 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(lets,cljs.core.first(params__$1)),gparam);
params__$1 = G__26191;
new_params = G__26192;
lets = G__26193;
continue;
...
var G__26109 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(expr_meta,new cljs.core.Keyword(null,"ns","ns",441598760),cljs.core.deref(sci.impl.utils.current_ns),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"file","file",-1269645878),cljs.core.deref(sci.impl.utils.current_file)], 0));
if(cljs.core.truth_(special_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26109,new cljs.core.Keyword(null,"special","special",-1125941630),true);
} else {
return G__26109;
}
}));
...
var args__5775__auto__ = [];
var len__5769__auto___26201 = arguments.length;
var i__5770__auto___26203 = (0);
while(true){
if((i__5770__auto___26203 < len__5769__auto___26201)){
args__5775__auto__.push((arguments[i__5770__auto___26203]));

var G__26204 = (i__5770__auto___26203 + (1));
i__5770__auto___26203 = G__26204;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.utils.log.cljs$lang$applyTo = (function (seq26110){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq26110));
}));
...
var G__26139 = sci.impl.utils.new_var.cljs$core$IFn$_invoke$arity$4(name,null,null,false);
sci.impl.vars.unbind(G__26139);
